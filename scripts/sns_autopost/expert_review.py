...
- hook: 「【声タイプ図鑑】◯◯」式のラベル陳列・カタログ説明・タイプ定義の提示で始まる本投稿は
  ...
  「あなたの声、歌手なら誰に似てる？」のように“自分の正体を知りたくなる問い”で始まり、
  最大の答え(似てる歌手＝結果)を見せずに引っぱる=20〜25。
- algo/concrete: 自己リプが「リンクだけ」「診断はこちら」だけ=価値ゼロ → algo は 0〜6。
  自己リプに『8タイプ早見』など“読む・自分を探す価値”があり、かつ結果(似てる歌手)は本編に残す
  設計 = algo 12〜15・concrete も加点。
- 80点未満なら revised_text は必ず“似てる歌手フック”に直し、revised_reply は8タイプ早見を保つ。
