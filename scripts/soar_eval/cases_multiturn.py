...
_TEMPLATES = [
    ...
    # 短い承諾・訂正・不満（2026-08-07 実会話スクショの再現。docs/93/94）
    # 「よろ」を承諾と読めるか／「〜やん」の指摘を訂正と読めるか／
    # 不満に同じ返答を繰り返さず修復できるか（無ければ探しに行けるか）
    ("video-accept-repair", [
        "エッジボイスってどうやるの？",
        "よろ",
        "リップロールやん",
    ...
    # 雑談の数字・話題に引っ張られないか（状態汚染はユニットテスト
    # test_state_pollution.py で検査済み。ここでは会話の噛み合いだけ診る）
    ("smalltalk-numbers", [
        "昨日カラオケで90〜95点出た！",
        "リズムは得意なんだけど、高音がなあ",
        "で、何の話だっけ",
