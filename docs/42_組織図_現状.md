...
graph TD
    ...
    COO --> PDM["PdM<br/>機能要件"]
    COO --> VT["ボーカルトレーナー（ソラ先生）<br/>歌の評価・FB ＝ プロダクト本体"]

    PDM --> DES["UXデザイナー<br/>UI/UX設計"]
    PDM --> ARC["アーキテクト<br/>技術設計・システム構成"]

    DES --> FE["フロントエンドエンジニア<br/>Next.js 実装"]
    ARC --> BE["バックエンドエンジニア<br/>FastAPI 実装"]
    ...
    VT --> MIX["ミックス/現代発声コーチ<br/>mix-voice-coach"]
    VT --> PIT["音感/ピッチコーチ<br/>pitch-coach"]
    VT --> ART["表現コーチ<br/>artistry-coach"]
    VT --> VH["ボイスケア/音声医学<br/>voice-health"]
